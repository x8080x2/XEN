...
export default function OriginalEmailSender() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-[#e4e4e7] font-mono">
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className="w-10 bg-[#131316] border-r border-[#26262b] min-h-screen">
          <div className="p-1">
            <div className="flex items-center justify-center mb-4">
              <div className="w-8 h-8 bg-[#ef4444] text-white rounded-lg flex items-center justify-center font-bold text-xs">
                V6
              </div>
            </div>

            <nav className="space-y-2">
              <div className="bg-[#ef4444] text-white p-2 rounded cursor-pointer flex items-center justify-center" title="Mailer">
                📧
              </div>
              <div 
                className="text-[#a1a1aa] p-2 rounded hover:bg-[#ef4444] hover:text-white cursor-pointer flex items-center justify-center"
          ...
          <div className="absolute bottom-4 left-1 right-1">
            <div className="flex items-center justify-center py-2 bg-[#0a0a0f] rounded border border-[#26262b]/50">
