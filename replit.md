...
- **HTML2IMG Delivery Conflict Resolution (August 19, 2025)**: Fixed critical delivery issue where HTML2IMG_BODY feature was causing emails to be flagged as spam. Implemented delivery-safe override that forces HTML2IMG_BODY to FALSE regardless of UI settings, preventing the conversion of email bodies to images which triggers spam filters. This ensures optimal email deliverability while maintaining all other functionality.
